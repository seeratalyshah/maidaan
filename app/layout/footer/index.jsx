...
import bgImage from "@/images/layout-images/footer-bg.jpg";
import bgImage2 from "@/images/layout-images/footer-bg2.png";
import {
  FaFacebook,
  FaInstagram,
  FaTiktok,
...
import logo from "@/images/layout-images/maidan-white-logo.png";
          ...
          <ul className="flex flex-wrap justify-center gap-4 text-sm mb-10">
            {menuItems.map((item) => (
              <Link key={item.path} href={item.path}>
                <li className="text-gray-400 hover:text-white">{item.name}</li>
              </Link>
            ))}
          </ul>
